        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
           ...
           <div className='create-job-flex'>
            ...
            <div className='lg:w-1/2 w-full'>
                ...
                <input type="text" placeholder='Ex: New York'  defaultValue={jobLocation} {...register("maxPrice")} className='create-job-input'/>
            </div>
           </div>
           ...
           {/* 5ht row */}
            ...
            <label  className='block mb-2 text-lg' >Required Skill Sets: </label>
                <CreatableSelect defaultValue={skills} onChange={setSelectedOption} isMulti options={options} className = "create-job-input py-4"/>
            </div>
           ...
           <div className='lg:w-1/2 w-full'>
                ...
                <input type="url"  defaultValue={companyLogo} placeholder='Paste your company logo URL: https://weshare.com/img1' {...register("companyLogo")} className='create-job-input'/>
            </div>
            <div className='lg:w-1/2 w-full'>
           ...
           <label htmlFor="" className='block mb-2 text-lg'>Job Description</label>
                    <option value="Full-time">Full-time</option>
           <textarea className='w-full pl-12 py-1.5 focus:outline-none' defaultValue={description} rows={6} placeholder='Job Description'  {...register("description")}/>
